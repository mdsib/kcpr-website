...
require_once("php/library/autouploader.php");


function get_calendar_events(
  $gmail,kcpr.internet@gmail.com                      // the 'Calendar ID' code (as shown in your 'calendar settings')
  ...
  elseif ($theme === "nice_theme") {
    ...
    $html = array(
      ...
      array(
        ...
        "after"   => "",
        "ifempty" => "      <span class=\"indent\">Kiireinen" ),
      array(
        "before"  => ", ",
        "after"   => "</span>\n    </p>\n",
        "ifempty" => "</span>\n    </p>\n" ),
